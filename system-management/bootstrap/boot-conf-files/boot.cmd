...
setenv earlycon "off"
setenv fdtfile "sun8i-h2-plus-bananapi-m2-zero.dtb"
...
setenv bootargs "root=${rootdev} rootwait rootfstype=${rootfstype} rw ${consoleargs} hdmi.audio=EDID:0 disp.screen0_output_mode=${disp_mode} consoleblank=0 loglevel=${verbosity} ubootpart=${partuuid} ubootsource=${devtype} usb-storage.quirks=${usbstoragequirks} ${extraargs} ${extraboardargs}"
